...
suite('Functional Tests', function() {
  ...
  suite('Integration tests with chai-http', function() {
    ...
    suite('GET /hello?name=[name] => "hello [name]"', function(){
      ...
      test('Test GET /hello with your name',  function(done){ // Don't forget the callback...
         chai.request(server)             // 'server' is the Express App
          .get('/hello?name=xy_zabc') /** <=== Put your name in the query **/ 
          .end(function(err, res){        // res is the response object
            ...
            assert.equal(res.status, 200);
             assert.equal(res.text, 'hello xy_zabc'/** <==  Put your name here **/);
            done();   // Always call the 'done()' callback when finished.
          });
      });
  ...
  Browser.site = 'https://abounding-abrupt-appeal.glitch.me'; 
      ...
      test('submit "surname" : "Vespucci" - write your e2e test...', function(done) {
        ...
        browser
          ...
          .pressButton('submit', function(){
            ...
            // assert that the text inside the element 'span#name' 
            browser.assert.text('span#name', 'Amerigo');
            // assert that the text inside the element 'span#surname' 
